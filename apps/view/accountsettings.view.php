    ...
    <div class="row-fluid">
        <div class="span8 offset4 text-center">
            <div class="span3">
                ...
                <div class="row-fluid">
                    <select id="careerLvl" name="careerLvl" class="span12" data-bind="value: user().careerLvl">
            ...
            <div class="span3">
                ...
                <div class="row-fluid">
                    <select id="education" class="span12" name="education" data-bind="value: user().education">
                        ...
                        <option value="4">College Diploma</option>
